...
export default function MainHomepageInfo() {
    ...
    return (
        <div className='flex justify-center p-2 m-2 gap-10'>

            {/* Card 1 */}
            <div className='flex flex-col items-center border rounded-xl bg-gray-900 text-center p-3 w-64 border-none'>
